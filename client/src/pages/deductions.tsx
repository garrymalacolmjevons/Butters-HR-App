        ...
        <DialogContent className="sm:max-w-[600px]">
          ...
          <FormProvider {...methods}>
            <div className="grid gap-4 py-4">
              {/* Enhanced Employee Search Component */}
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Approved deductions will be included in the next payroll processing.
                </p>
              </div>
              
              <div className="flex justify-end gap-2 pt-4">
                <Button variant="outline" onClick={() => setShowDeductionForm(false)}>
                  Cancel
                </Button>
                <Button 
                ...
                >
                  {createDeduction.isPending || updateDeduction.isPending ? 
                    "Saving..." : 
                    isEditMode ? "Update Deduction" : "Save Deduction"}
                </Button>
              </div>
            </div>
          </FormProvider>
